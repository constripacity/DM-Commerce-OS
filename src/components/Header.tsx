...
export function Header({ onSimulateMessage, onSimulatePayment, onStartSimulation, isSimulationRunning, onToggleDemo, isDemoMode }: HeaderProps) {
      ...
      <div className="flex items-center gap-2 flex-wrap">
        ...
        <div className="flex items-center gap-2 ml-4">
          ...
          <button
            ...
            className={`flex items-center gap-1 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
              isDemoMode ? 'bg-indigo-100 text-indigo-800' : 'bg-gray-100 text-gray-600'
            }`}
          >
